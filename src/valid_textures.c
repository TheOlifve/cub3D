...
/*   Updated: 2024/04/07 12:41:34 by hrahovha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	no_texture(t_mlx *mlx, t_game *game)
{
	...
	game->NO = mlx_xpm_file_to_image(mlx->mlx, tmp[1], &i, &j);
	doublefree(tmp);
	return (0);
}
...
int	so_texture(t_mlx *mlx, t_game *game)
{
	...
	game->SO = mlx_xpm_file_to_image(mlx->mlx, tmp[1], &i, &j);
	doublefree(tmp);
	return (0);
}
...
int	we_texture(t_mlx *mlx, t_game *game)
{
	...
	game->WE = mlx_xpm_file_to_image(mlx->mlx, tmp[1], &i, &j);
	doublefree(tmp);
	return (0);
}
...
int	ea_texture(t_mlx *mlx, t_game *game)
{
	...
	game->EA = mlx_xpm_file_to_image(mlx->mlx, tmp[1], &i, &j);
	doublefree(tmp);
	return (0);
}
